...
void Reward_21_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Reward_21_run(uint ctx_index,Circom_CalcWit* ctx);
...
uint get_total_signal_no() {return 401673;}
...
Fr_sub(&expaux[2],&circuitConstants[0],&signalValues[mySignalStart + 1]); // line circom 11
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 2],&signalValues[mySignalStart + 1]); // line circom 13
// end load src
...
// load src
Fr_sub(&expaux[1],&circuitConstants[0],&signalValues[mySignalStart + 1]); // line circom 14
Fr_mul(&expaux[0],&signalValues[mySignalStart + 3],&expaux[1]); // line circom 14
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_add(&expaux[1],&signalValues[mySignalStart + 4],&signalValues[mySignalStart + 5]); // line circom 15
Fr_mul(&expaux[0],&expaux[1],&circuitConstants[0]); // line circom 15
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
for (uint i = 0; i < 0; i++){
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 0],&signalValues[mySignalStart + 5]); // line circom 36
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// no need to run sub component
...
// load src
Fr_sub(&expaux[1],&circuitConstants[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[3]].signalStart + 0]); // line circom 43
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + 0],&expaux[1]); // line circom 43
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 4],&ctx->signalValues[ctx->componentMemory[mySubcomponents[3]].signalStart + 0]); // line circom 44
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 0];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 10],&signalValues[mySignalStart + 11]); // line circom 45
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
for (uint i = 0; i < 4; i++){
...
uint csoffset = mySignalStart+632;
...
uint csoffset = mySignalStart+546;
for (uint i = 0; i < 1; i++) {
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 1],&circuitConstants[12]); // line circom 26
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// run sub component if needed
...
PFrElement aux_dest = &signalValues[mySignalStart + 4];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 7],&ctx->signalValues[ctx->componentMemory[mySubcomponents[3]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[3]].templateId].defs[0].offset]); // line circom 29
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
PFrElement aux_dest = &signalValues[mySignalStart + 10];
// load src
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + 0]); // line circom 38
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
PFrElement aux_dest = &signalValues[mySignalStart + 11];
// load src
Fr_sub(&expaux[1],&circuitConstants[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + 0]); // line circom 43
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + 0],&expaux[1]); // line circom 43
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 3];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 10],&signalValues[mySignalStart + 11]); // line circom 44
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 3],&signalValues[mySignalStart + 3]); // line circom 46
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId].defs[1].offset+map_index_aux[0]];
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 16],&signalValues[mySignalStart + 3]); // line circom 48
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// run sub component if needed
...
// load src
Fr_add(&expaux[1],&signalValues[mySignalStart + 4],&ctx->signalValues[ctx->componentMemory[mySubcomponents[4]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[4]].templateId].defs[0].offset]); // line circom 50
Fr_mul(&expaux[0],&expaux[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + 0]); // line circom 50
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_sub(&expaux[1],&signalValues[mySignalStart + 4],&ctx->signalValues[ctx->componentMemory[mySubcomponents[4]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[4]].templateId].defs[0].offset]); // line circom 51
Fr_sub(&expaux[2],&circuitConstants[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + 0]); // line circom 51
Fr_mul(&expaux[0],&expaux[1],&expaux[2]); // line circom 51
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 5];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 12],&signalValues[mySignalStart + 13]); // line circom 52
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 16],&signalValues[mySignalStart + 16]); // line circom 54
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId].defs[1].offset+map_index_aux[0]];
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 17],&signalValues[mySignalStart + 3]); // line circom 56
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// run sub component if needed
...
// load src
Fr_add(&expaux[1],&signalValues[mySignalStart + 5],&ctx->signalValues[ctx->componentMemory[mySubcomponents[5]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[5]].templateId].defs[0].offset]); // line circom 58
...
// load src
Fr_sub(&expaux[1],&signalValues[mySignalStart + 5],&ctx->signalValues[ctx->componentMemory[mySubcomponents[5]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[5]].templateId].defs[0].offset]); // line circom 59
...
PFrElement aux_dest = &signalValues[mySignalStart + 6];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 14],&signalValues[mySignalStart + 15]); // line circom 60
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
PFrElement aux_dest = &signalValues[mySignalStart + 5];
// load src
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + 0],&signalValues[mySignalStart + 1]); // line circom 88
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
PFrElement aux_dest = &signalValues[mySignalStart + 5];
// load src
Fr_sub(&expaux[1],&signalValues[mySignalStart + 3],&signalValues[mySignalStart + 4]); // line circom 26
Fr_mul(&expaux[0],&expaux[1],&signalValues[mySignalStart + 1]); // line circom 26
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 6];
// load src
Fr_sub(&expaux[1],&signalValues[mySignalStart + 4],&signalValues[mySignalStart + 3]); // line circom 27
Fr_sub(&expaux[2],&circuitConstants[0],&signalValues[mySignalStart + 1]); // line circom 27
Fr_mul(&expaux[0],&expaux[1],&expaux[2]); // line circom 27
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 5],&signalValues[mySignalStart + 6]); // line circom 31
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// no need to run sub component
...
PFrElement aux_dest = &signalValues[mySignalStart + 5];
// load src
Fr_sub(&expaux[1],&signalValues[mySignalStart + 2],&signalValues[mySignalStart + 3]); // line circom 23
Fr_mul(&expaux[0],&expaux[1],&circuitConstants[0]); // line circom 23
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 9];
// load src
Fr_add(&expaux[1],&signalValues[mySignalStart + 2],&signalValues[mySignalStart + 3]); // line circom 26
Fr_mul(&expaux[0],&expaux[1],&signalValues[mySignalStart + 4]); // line circom 26
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 10];
// load src
Fr_sub(&expaux[1],&signalValues[mySignalStart + 2],&signalValues[mySignalStart + 3]); // line circom 27
Fr_sub(&expaux[2],&circuitConstants[0],&signalValues[mySignalStart + 4]); // line circom 27
Fr_mul(&expaux[0],&expaux[1],&expaux[2]); // line circom 27
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
...
PFrElement aux_dest = &signalValues[mySignalStart + 8];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 9],&signalValues[mySignalStart + 10]); // line circom 28
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
ctx->componentMemory[coffset].templateName = "Reward";
ctx->componentMemory[coffset].signalStart = soffset;
...
uint csoffset = mySignalStart+156424;
...
uint aux_create = 256;
int aux_cmp_num = 0+ctx_index+1;
uint csoffset = mySignalStart+6664;
uint aux_dimensions[1] = {256};
for (uint i = 0; i < 256; i++) {
...
uint csoffset = mySignalStart+77064;
uint aux_dimensions[1] = {256};
for (uint i = 0; i < 256; i++) {
...
uint csoffset = mySignalStart+102664;
uint aux_dimensions[1] = {256};
for (uint i = 0; i < 256; i++) {
...
uint csoffset = mySignalStart+107272;
uint aux_dimensions[1] = {256};
for (uint i = 0; i < 256; i++) {
...
uint csoffset = mySignalStart+131848;
uint aux_dimensions[1] = {256};
for (uint i = 0; i < 256; i++) {
...
uint csoffset = mySignalStart+158984;
uint aux_dimensions[1] = {256};
for (uint i = 0; i < 256; i++) {
...
uint csoffset = mySignalStart+210696;
uint aux_dimensions[1] = {256};
for (uint i = 0; i < 256; i++) {
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[18]); // line circom 63
while(Fr_isTrue(&expaux[0])){
Fr_sub(&expaux[3],&circuitConstants[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[2])) + 1543)]); // line circom 64
Fr_mul(&expaux[2],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[2])) + 1543)],&expaux[3]); // line circom 64
Fr_eq(&expaux[0],&circuitConstants[1],&expaux[2]); // line circom 64
...
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[2])) + 6408)];
// load src
// end load src
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[2])) + 6408)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[2])) + 1031)],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[2])) + 4616)]); // line circom 101
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[2])) + 4360)],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[2])) + 5128)]); // line circom 115
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
Reward_21_create(1,0,ctx,"main",0);
Reward_21_run(0,ctx);
}
