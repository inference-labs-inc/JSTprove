...
// use jstprove_circuits::circuit_functions::helper_fn::{four_d_array_to_vec, load_circuit_constant, read_2d_weights, read_4d_weights};
...
// const MATRIX_WEIGHTS_FILE: &str = include_str!("../../weights/doom_2_weights.json");
...
//     outputs: [[Variable; 3]; 1], // shape (m, k)
// });
...
//         if WEIGHTS_INPUT.fc1_alpha != 1 ||WEIGHTS_INPUT.fc1_beta != 1 || WEIGHTS_INPUT.fc2_alpha != 1 || WEIGHTS_INPUT.fc2_beta != 1{
...
//         api.display("first conv", out[0][0][0][0]);
...
//         api.display("out2d", out_2d[0][0]);

//         let weights = read_2d_weights(api, &WEIGHTS_INPUT.fc2_weights);
//         let bias = read_2d_weights(api, &WEIGHTS_INPUT.fc2_bias);
...
//                     let temp_1 = api.neg(self.outputs[j][k]);
//                     let temp_2 = api.neg(out_2d[j][k]);
//                     api.display("out1",temp_1);
//                     api.display("out2", temp_2);
