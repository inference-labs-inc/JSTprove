...
{
    fn read_inputs(&mut self, file_path: &str, mut assignment: ReLUDualCircuit<C::CircuitField>) -> ReLUDualCircuit<C::CircuitField>
    {
        let data: InputData = <FileReader as IOReader<C, ReLUDualCircuit<_>>>::read_data_from_json::<InputData>(file_path); 
    ...
    fn read_outputs(&mut self, file_path: &str, mut assignment: ReLUDualCircuit<C::CircuitField>) -> ReLUDualCircuit<C::CircuitField>
    {

        let data: OutputData = <FileReader as IOReader<C, ReLUDualCircuit<_>>>::read_data_from_json::<OutputData>(file_path); 
