...
// fn where_fn<C: Config>(api: &mut API<C>, p: &Vec<Variable>) -> Vec<Variable> {
//     let mut ss = vec![vec![api.ne(0); 64]; 25];
...
mod io_reader {
    ...
    // Assign inputs to circuit input
    ...
    // Assign outputs to circuit outputs
