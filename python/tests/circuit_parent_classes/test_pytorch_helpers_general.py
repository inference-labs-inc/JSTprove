...
# from python.core.utils.model_converter import GeneralLayerFunctions
...
# @pytest.mark.unit
# @patch("python.core.utils.model_converter.torch.tensor")
# @patch("python.core.utils.model_converter.onnx.numpy_helper.to_array")
...
# @pytest.mark.unit
# @patch("python.core.utils.model_converter.ort.InferenceSession")
