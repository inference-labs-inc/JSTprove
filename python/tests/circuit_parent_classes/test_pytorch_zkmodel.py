...
# ---------- Inheritance ----------
@pytest.mark.unit
@patch("python.core.utils.pytorch_helpers.torch.save")
...
@pytest.mark.unit
@patch("python.core.utils.pytorch_helpers.torch.load", return_value={"weights": 123})
