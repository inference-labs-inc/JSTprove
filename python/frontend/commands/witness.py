...
class WitnessCommand(BaseCommand):
    ...
    def run(cls, args: argparse.Namespace) -> None:
        ...
        if not all([args.circuit_path, args.input_path, args.output_path, args.witness_path]):
            raise ValueError("witness requires circuit_path, input_path, output_path, and witness_path")
