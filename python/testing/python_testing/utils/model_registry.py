...
import pkgutil
import pytest
from python.testing import python_testing

from python.testing.python_testing.circuit_models.demo_cnn import Demo
...
from python.testing.python_testing.circuit_models.generic_onnx import GenericModelONNX
