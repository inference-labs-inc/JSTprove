...
from python.testing.core.utils.helper_functions import compile_circuit, compute_and_store_output, create_folder, generate_proof, generate_verification, generate_witness, get_expander_file_paths, get_files, prepare_io_files, run_end_to_end, run_expander_exec, to_json, read_from_json, run_cargo_command, prove_and_verify
from python.testing.core.utils.helper_functions import RunType, ZKProofSystems
...
@patch("python.testing.core.utils.helper_functions.open", new_callable=mock_open)
...
@pytest.mark.unit
@patch("python.testing.core.utils.helper_functions.os.path.exists", return_value=True)
@patch("python.testing.core.utils.helper_functions.open", new_callable=mock_open, read_data='{"out": 456}')
@patch("python.testing.core.utils.helper_functions.json.load", return_value={"out": 456})
...
@patch("python.testing.core.utils.helper_functions.os.path.exists", return_value=True)
@patch("python.testing.core.utils.helper_functions.open", new_callable=mock_open)
@patch("python.testing.core.utils.helper_functions.json.load", side_effect=json.JSONDecodeError("msg", "doc", 0))
@patch("python.testing.core.utils.helper_functions.json.dump")
...
# ---------- prepare_io_files ----------
@pytest.mark.unit
@patch("python.testing.core.utils.helper_functions.get_files", return_value=[
    "witness.wtns", "input.json", "proof.json", "public.json",
    "vk.key", "test_circuit", "weights.json", "out.json"
])
@patch("python.testing.core.utils.helper_functions.to_json")
@patch("python.testing.core.utils.helper_functions.os.path.splitext", return_value=("model", ".circom"))
@patch("python.testing.core.utils.helper_functions.open", new_callable=mock_open)
...
# ---------- read_from_json ----------
@pytest.mark.unit
@patch("python.testing.core.utils.helper_functions.open", new_callable=mock_open, read_data='{"x": 42}')
@patch("python.testing.core.utils.helper_functions.json.load", return_value={"x": 42})
...
# ---------- run_cargo_command ----------
@pytest.mark.unit
@patch("python.testing.core.utils.helper_functions.subprocess.run")
...
@pytest.mark.unit
@patch("python.testing.core.utils.helper_functions.subprocess.run", side_effect=Exception("subprocess failed"))
...
@patch("python.testing.core.utils.helper_functions.run_cargo_command")
...
@pytest.mark.integration
@patch("python.testing.core.utils.helper_functions.run_cargo_command", side_effect=Exception("boom"))
...
@pytest.mark.integration
@patch("python.testing.core.utils.helper_functions.run_expander_raw")
@patch("python.testing.core.utils.helper_functions.get_expander_file_paths", return_value={
    "circuit_file": "c.circ",
    "witness_file": "w.wtns",
    "proof_file": "p.pf"
})
...
@pytest.mark.integration
@patch("python.testing.core.utils.helper_functions.run_cargo_command", side_effect = Exception("TEST"))
...
# # ---------- run_end_to_end ----------
@pytest.mark.unit
@patch("python.testing.core.utils.helper_functions.generate_verification")
@patch("python.testing.core.utils.helper_functions.generate_proof")
@patch("python.testing.core.utils.helper_functions.generate_witness")
@patch("python.testing.core.utils.helper_functions.compile_circuit")
...
@pytest.mark.unit
@patch("python.testing.core.utils.helper_functions.create_folder")
