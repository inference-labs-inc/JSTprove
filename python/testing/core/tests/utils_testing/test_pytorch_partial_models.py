...
from python.testing.core.utils.pytorch_partial_models import QuantizedLinear, QuantizedConv2d
from python.testing.core.utils.pytorch_partial_models import (
