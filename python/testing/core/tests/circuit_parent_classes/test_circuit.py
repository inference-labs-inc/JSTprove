...
@pytest.mark.unit
@patch("python.testing.core.circuit_components.circuit_helpers.prove_and_verify")
@patch("python.testing.core.circuit_components.circuit_helpers.compile_circuit")
@patch("python.testing.core.circuit_components.circuit_helpers.generate_witness")
@patch("python.testing.core.circuit_components.circuit_helpers.generate_proof")
@patch("python.testing.core.circuit_components.circuit_helpers.generate_verification")
@patch("python.testing.core.circuit_components.circuit_helpers.run_end_to_end")
...
def test_get_inputs_from_file():
    ...
    c.scale_base = 2
    c.scaling = 2
    with patch('python.testing.core.circuit_components.circuit_helpers.read_from_json', return_value = {"input":[1,2,3,4]}):
...
def test_get_inputs_from_file_multiple_inputs():
    ...
    c.scale_base = 2
    c.scaling = 2
    with patch('python.testing.core.circuit_components.circuit_helpers.read_from_json', return_value = {"input":[1,2,3,4], "nonce": 25}):
        x = c.get_inputs_from_file("", is_scaled=True)
...
@pytest.mark.unit
@patch("python.testing.core.circuit_components.circuit_helpers.to_json")
...
@patch("python.testing.core.circuit_components.circuit_helpers.compile_circuit", side_effect=Exception("Boom goes the dynamite!"))
