...
@pytest.mark.unit
@patch("python.testing.core.utils.onnx_converter.onnx.save")
...
@pytest.mark.unit
@patch("python.testing.core.utils.onnx_converter.onnx.load")
@patch("python.testing.core.utils.onnx_converter.onnx.checker.check_model")
...
@pytest.mark.unit
@patch("python.testing.core.utils.onnx_converter.SessionOptions")
@patch("python.testing.core.utils.onnx_converter.ort.InferenceSession")
@patch("python.testing.core.utils.onnx_converter.onnx.checker.check_model")
@patch("python.testing.core.utils.onnx_converter.onnx.load")
