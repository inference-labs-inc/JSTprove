...
class BaseOpQuantizer:
    ...
    def rescale_layer(self, node: onnx.NodeProto, scale_base: int, scale: int, graph: onnx.GraphProto) -> List[onnx.NodeProto]:
        """
    ...
    def insert_scale_node(self, tensor: onnx.TensorProto, scale_base: int, scale: int, graph: onnx.GraphProto) -> tuple[str, onnx.NodeProto, onnx.NodeProto]: 
