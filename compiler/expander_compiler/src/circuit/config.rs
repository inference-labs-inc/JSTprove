...
pub use gkr::{
    ...
    Goldilocksx1ConfigSha2Basefold, Goldilocksx1ConfigSha2Raw, Goldilocksx8ConfigSha2Lattice,
...
pub type GoldilocksLatticeConfig = Goldilocksx8ConfigSha2Lattice;

impl Config for GoldilocksLatticeConfig {
