...
pub use sparse::{
    ...
    whir_open_at_combined_point, whir_verify_with_claim, AddrTimestamps, EvalConstituent,
    ...
    SparseEvalLayout, SparseEvalScratch, SparseEvalSlot, SparseFullOpening,
    SparseFullOpeningScratch, SparseLayout, SparseMle3, SparseMle3Commitment, SparseMle3Opening,
    SparseMleError, SparseMleScratchPad, SparseMultisetOpening, WhirGlueError, WhirOpenWithClaim,
    MEMCHECK_HASH_VARS,
};
pub use types::*;
