...
fn parse_field_type(field_expr: ExprPath) -> (String, String) {
    ...
    match field_enum.ident.to_string().as_str() {
        ...
        "GoldilocksExt4x1" => (
            "GoldilocksExt4x1".to_owned(),
            "GoldilocksExt4x1Config".to_owned(),
        ),
...
fn parse_polynomial_commitment_type(
    ...
    match (pcs_type_str.as_str(), field_type) {
        ...
        ("Basefold", "Goldilocksx1") | ("Basefold", "GoldilocksExt2x1") => (
            "FRI".to_owned(),
            format!("BasefoldPCSForGKR::<{field_config}>").to_owned(),
        ),
        ("Whir", "Goldilocksx1") | ("Whir", "GoldilocksExt2x1") | ("Whir", "GoldilocksExt3x1") | ("Whir", "GoldilocksExt4x1") => (
            "Whir".to_owned(),
